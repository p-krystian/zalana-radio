...
function Controls({ playing, manager }: ControlsProps) {
  return (
    <div class="pyr-flex-evenly">
      <Button onClick={() => manager?.backward()} value={t.backward}>
      ...
      <Button onClick={() => manager?.play()} clicked={playing} value={t.play}>
        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
          <title>{t.play}</title>
          <path
            d="M448 256c0-106-86-192-192-192S64 150 64 256s86 192 192 192 192-86 192-192z"
      ...
      <Button onClick={() => manager?.forward()} value={t.forward}>
        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
